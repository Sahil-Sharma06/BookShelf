const booksData = [
    ...
    description: "Harper Lee's classic novel of a lawyer in the Deep South defending a black man charged with the rape of a white girl."
    },
    {
      id: 2,
      title: "1984",
      description: "George Orwell's dystopian masterpiece, 1984 is a novel about totalitarianism and the fate of a single.",
    ...
    },
    {
      ...
      description: "J.D. Salinger's story of Holden Caulfield, a teenage boy who finds himself estranged from the adult world."
    },
    {
      id: 4,
      imageUrl:"https://cdn.britannica.com/31/213831-050-D073CF0A/movie-still-Robert-Redford-The-Great-Gatsby-1974.jpg",
      title: "The Great Gatsby",
      description: "F. Scott Fitzgerald's novel set in the Jazz Age on Long Island, near New York City, is a critique of the American Dream."
    },
    {
      id: 5,
      ...
      description: "Jane Austen's novel follows the character development of Elizabeth Bennet, the dynamic protagonists."
    },
    {
      id: 6,
